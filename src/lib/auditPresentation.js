...
export const auditActivity = row => {
  ...
  const labels = {
    ...
    'trainer.roles_corrected': 'Corrected trainer account access',
    ...
    'staff.deactivated': 'Deactivated the staff account',
    'staff.roles_corrected': 'Corrected staff account access',
